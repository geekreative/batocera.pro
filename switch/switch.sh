...
ORIGIN="https://github.com/geekreative/batocera-switch/blob/project/system" 
#---------------------------------------------------------------------
######################################################################
ORIGIN="${ORIGIN^^}"
...
url=https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra
...
url=https://github.com/geekreative/batocera-switch/blob/project/system/configs/emulationstation
...
url=https://github.com/geekreative/batocera-switch/blob/project/system/configs/evmapy
wget -q -O "$path/switch.keys" "$url/switch.keys"
# -------------------------------------------------------------------- 
# FILL /USERDATA/ROMS/PORTS 
path=/userdata/roms/ports 
url=https://github.com/geekreative/batocera-switch/project/roms/ports
wget -q -O "$path/Switch Updater.sh" "$url/Switch Updater.sh"
# -------------------------------------------------------------------- 
# FILL /USERDATA/ROMS/PORTS/IMAGES 
path=/userdata/roms/ports/images
url=https://github.com/geekreative/batocera-switch/project/roms/ports/images
...
url=https://github.com/geekreative/batocera-switch/project/roms/switch
wget -q -O "$path/_info.txt" "$url/_info.txt"
# -------------------------------------------------------------------- 
# FILL /USERDATA/BIOS/SWITCH 
path=/userdata/bios/switch
url=https://github.com/geekreative/batocera-switch/project/bios/switch
wget -q -O "$path/_info.txt" "$url/_info.txt"
# -------------------------------------------------------------------- 
# REMOVE OLD UPDATERS 
...
wget -q -O "/tmp/batocera-switch-updater.sh" "https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-updater.sh" 
