...
ORIGIN="https://github.com/geekreative/batocera-switch/tree/project" 
#---------------------------------------------------------------------
######################################################################
ORIGIN="${ORIGIN^^}"
...
wget -q -O "/tmp/batocera-switch-updater.sh" "https://raw.githubusercontent.com/geekreative/batocera-switch/project/system/switch/extra/batocera-switch-updater.sh" 
