         ...
         ####################################################################
            u=/userdata/system/switch/extra/batocera-switch-desktopupdater.sh
               rm "$u" 2>/dev/null
                  ...
                  echo "  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /tmp/.batocera-switch-updater.sh https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-updater.sh" >> "$u"
                  ##echo "  curl -sSf https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-updater.sh -o /tmp/.batocera-switch-updater.sh " >> "$u"
...
EMULATORS="$(echo $EMULATORS | sed 's/ /-/g')"
   ...
   if [[ ! -f $cfg ]]; then 
      link_defaultconfig=https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-config.txt
...
# ------------------------------------------------------------------- 
   extraurl="https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra"
# ------------------------------------------------------------------- 
...
#   wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/configgen/mapping.csv" "https://github.com/geekreative/batocera-switch/blob/project/system/switch/configgen/mapping.csv"
...
# -------------------------------------------------------------------
# prepare patcher 
url_patcher="https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-patcher.sh"
...
url_updater=https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-updater.sh
url_portsupdater=https://github.com/geekreative/batocera-switch/project/roms/ports/Switch%20Updater.sh
url_portsupdaterkeys=https://github.com/geekreative/batocera-switch/project/roms/ports/Switch%20Updater.sh.keys   
...
url=https://github.com/geekreative/batocera-switch/blob/project/system/switch/configgen
...
url=https://github.com/geekreative/batocera-switch/blob/project/system/switch/configgen/generators
mkdir -p $path 2>/dev/null
...
url=https://github.com/geekreative/batocera-switch/blob/project/system/switch/configgen/generators/yuzu
mkdir -p $path 2>/dev/null
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
url=https://github.com/geekreative/batocera-switch/blob/project/system/switch/configgen/generators/ryujinx
mkdir -p $path 2>/dev/null
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
# additional pass for folks who have issues connecting to github
   function get() {
      file="$1"
      path=/userdata/system/switch/configgen/sdl2
      url=https://github.com/geekreative/batocera-switch/blob/project/system/switch/configgen/sdl2
         mkdir -p $path 2>/dev/null
            if [[ ! -e "$path/$file" ]]; then
               cd $path
...
sdlurl=https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-libSDL2.so
   if [[ ! -e "$sdl" ]]; then 
...
urldir="https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra"
...
url=https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/translations
mkdir -p $path 2>/dev/null
...
# GET TRANSLATOR
translator=https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-translator.sh
...
# include display output: 
   ...
   mkdir /userdata/system/switch 2>/dev/null; mkdir /userdata/system/switch/extra 2>/dev/null
      if [[ ( -e "$tput" && "$(wc -c "$tput" | awk '{print $1}')" < "444" ) || ( ! -e "$tput" ) ]]; then
         ...
         ##curl -sSf "https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-tput" -o "/userdata/system/switch/extra/batocera-switch-tput"
      fi
      if [[ ( -e "$libtinfo" && "$(wc -c "$libtinfo" | awk '{print $1}')" < "444" ) || ( ! -e "$libtinfo" ) ]]; then
         ...
         ##curl -sSf "https://github.com/geekreative/batocera-switch/blob/project/system/switch/extra/batocera-switch-libtinfo.so.6" -o "/userdata/system/switch/extra/batocera-switch-libtinfo.so.6"
      fi
